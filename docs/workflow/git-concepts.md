...
Complete walkthroughs for the most common types of work. Each example shows the full Pull → Work → Commit → Push flow from start to finish.
...
5. If the new page needs to appear in the docs site navigation, tell CC:
    ...
    > "Add this page to the mkdocs.yml nav under the Game Design section"
